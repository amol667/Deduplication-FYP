...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sptheory","root", "admin");
...
<body onload="startTimer()">
	...
	<div >
		<!--  <div id="popup" style="height: 400px; width: 800px; padding: 10px; background-color: #FFFFFF">-->
